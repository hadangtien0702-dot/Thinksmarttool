...
PRINCIPLES = [
    ...
    ("2. Data khách nằm trên máy sale", "Không server lưu data khách. Nháp = localStorage trình duyệt từng người. "
                     "Từ v1.10 có đăng nhập NỘI BỘ (video học/forum, Supabase) nhưng nguyên tắc không đổi: "
                     "data KHÁCH không bao giờ lên server. Đây là lợi thế privacy + compliance."),
...
RELEASES = [
    ("v1.10", "19/07/2026",
     "PORTAL Đợt 1 (local, chưa deploy): trang chủ nội bộ mới · Tool chuyển về /tool nguyên vẹn · "
     "trang Video học (YouTube/Drive, admin dán link) · Login email/mật khẩu + phân quyền Admin/Nhân viên "
     "(Supabase, RLS) · chế độ mở khi chưa dán key · 4 branch feat/* merge lần lượt",
     "Web từ 'cái tool' thành trang nội bộ công ty: học – làm – trao đổi một chỗ; nền tảng cho Forum Đợt 2; "
     "quy trình branch theo phần giúp lỗi phần nào khoanh phần đó."),
    ("v1.02", "17/07/2026",
...
def build_md(path):
    ...
    L.append("")
    L.append("> Bản Markdown đồng bộ với Google Sheet (bản nhìn-cho-người). Nguồn sự thật: `product/build-product-hub.py` — sửa DATA trong đó rồi chạy lại để tái sinh cả hai. Cập nhật: 19/07/2026.")
    L.append(">")
    L.append("> 📊 **Google Sheet:** https://docs.google.com/spreadsheets/d/1JzPxAoxjRCrgrqY5Lk86p1XyEWx3f47HyaBHGR4gWzY/edit")
    L.append(">")
    L.append("> 📁 **Drive folder:** https://drive.google.com/drive/folders/1SLfL8Xyjl3NPlEjjdodJKS9eUsEtQ75x — \"Thinksmart Tool — Product\" trong \"2). Thinksmart Insurance Video\" (Drive vickytrieu2017@gmail.com)")
    L.append("")
